    	...
    	<div class="col-md-6 well">
    		...
    		<div class="col-md-6">
    			...
    			<form method="POST" action="save_member.php">	
					...
					<div class="form-group">
    					<label>Is this a sellers account? (yes)</label>
    					<input type="checkbox" name="is_seller" class="form-control" value="1"/>
						<label>(no)</label>
						<input type="checkbox" name="is_seller" class="form-control" value="2"/>
    				</div>
    				<?php
    				...
    				<div class="alert alert-success"><?php echo $_SESSION['success']; header('location: login.php');?></div>
    				<?php
