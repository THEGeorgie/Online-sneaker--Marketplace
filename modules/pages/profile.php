			...
			<div class="col-sm-12 col-lg-6">
				...
				<p>
					<button class="btn btn-outline-light" type="button" data-bs-toggle="collapse"
						data-bs-target="#collapseAdress" aria-expanded="false" aria-controls="collapseExample">
						【Ａｄｄ　ａｄｄｒｅｓｓ】
					</button>
				</p>
				<div class="collapse" id="collapseAdress">
					<form method="POST" action="modules/scripts/save_address.php">
						<div class="row">
							<div class="col-6">
							...
							<div class="col-4">
								<div class="bg-transparent form-floating mt-3">
									<input type="text" name="country" class="form-control" id="City" placeholder="Name">
